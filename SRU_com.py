...
if __name__ == "__main__":
    ...
    thread1 = threading.Thread(target=serial_com_TC, args=(ser, lock, UI.buffer_layout, UI.watchdog_radio, args.loop))
    thread1.daemon = True
    thread1.start()

    thread2 = threading.Thread(target=serial_com_TM, args=(ser, lock, UI.buffer_layout, UI.TM_window, args.loop))
    thread2.daemon = True
    thread2.start()
