...
# frame_to_be_sent_bytes = bytearray.fromhex("AABBCCDDEEFF")
...
def accept_no():
    # run_in_executor(send_serial, _daemon=True)
    send_serial()
...
def run():
    ...
    get_event_loop().run_until_complete(application.run_async().to_asyncio_future())
